...
<?php
  $the_title = "We are Creative Studio";
  $the_filed['subtitle'] = "We love Ajax calls";
?>

	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/img_bg_<?php echo $page_id ?>.jpg);">
				...
				<div class="col-md-10 col-md-offset-1 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<h2><?php echo $the_filed['subtitle'] ?></h2>
